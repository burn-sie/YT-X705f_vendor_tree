...
BOARD_VENDOR := LENOVO
VENDOR_PATH := vendor/LENOVO/YTX705F/propriatery/vendor
...
#TARGET_KERNEL_CONFIG := lineage_YTX705F_defconfig
## You can access menuconfig without messing up the kernel build by running:
## make -C kernel/lenovo/msm8937 O=$OUT/obj/KERNEL_OBJ ARCH=arm64 menuconfig
...
# Filesystem    <--------------------------------------------------------------------------Double check these values
